...
```{r}
boxplot_graph <- function(raw, team_red_alliance, team_blue_alliance) {
...
```{r}
bubble_graph <- function(raw, team_red_alliance, team_blue_alliance) {
...
bubble_graph(raw,red_alliance,blue_alliance)
...
```{r}
bar_graph <- function(raw, team_red_alliance, team_blue_alliance) {
...
bar_graph(raw,red_alliance,blue_alliance)
```

CORAL SCORED DURING AUTO AND TELEOP

```{r}
tele_auto_graph <- function(raw, team_red_alliance, team_blue_alliance) {
...
tele_auto_graph(raw,red_alliance,blue_alliance)
...
```{r}
endgame_graph <- function(raw, team_red_alliance, team_blue_alliance) {
