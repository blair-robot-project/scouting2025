...
scout_id <- sample(c("Gabriel", "Tinbite", "Mitchell", "Sophia", "Jack"), size = n, replace = TRUE)
...
climb_attempt <- sample(c(TRUE, FALSE), size = n, replace = TRUE, prob = c(90, 10))
end_pos <- sample(c("No", "P", "S", "D"), size = n, replace = TRUE)
...
died_tipped <- sample(c("NA", "cs", "ba", "di", "de", "t"), size = n, replace = TRUE)

commentsMCQ <- sample(c("D, WB, WM, PP, W, BI, XLC", "WB, WM, PP, W, BI, XLC", "WM, PP, W, BI, XLC", "PP, W, BI, XLC", "W, BI, XLC", "BI, XLC", "XLC", "NA"), size = n, replace = TRUE, prob = c(5, 5, 5, 5, 5, 5, 5, 65))
